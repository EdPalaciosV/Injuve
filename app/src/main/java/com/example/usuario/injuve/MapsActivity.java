...
import com.example.usuario.injuve.Filter.FilterSheetDialog;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        containerFilter=findViewById(R.id.containerFilterDesign);
        bottomSheetBehavior= BottomSheetBehavior.from(containerFilter);
